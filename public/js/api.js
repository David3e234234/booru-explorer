...
export function getAuthHeaders(includeJson = false) {
  ...
  if (state && state.settings) {
    const authData = {
      ...
      pawchiveLogin: state.settings.pawchiveLogin || '',
      pawchivePassword: state.settings.pawchivePassword || '',
      kemonoSession: state.settings.kemonoSession || '',
      kemonoLogin: state.settings.kemonoLogin || '',
      kemonoPassword: state.settings.kemonoPassword || '',
