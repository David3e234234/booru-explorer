        ...
        if (entry.isIntersecting) {
          if (!videoEl.src) {
            ...
            if (videoTarget) {
              ...
              const shouldUseProxy = (post.site === 'danbooru' || videoTarget.includes('donmai.us')) ? true : (!isMyLiveDemo && state.settings?.proxyVideos !== false && state.settings?.proxyVideoDefault !== false);
